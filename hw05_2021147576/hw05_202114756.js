...
import { Pyramid } from '../hw05_2021147576/squarePyramid.js';
...
function render() {
    ...
    // Reset model matrix (no rotation)
    mat4.identity(modelMatrix);

    // Viewing transformation matrix
    let camX = 3.0 * Math.sin(glMatrix.toRadian(cameraCircleSpeed * elapsedTime));
    let camZ = 3.0 * Math.cos(glMatrix.toRadian(cameraCircleSpeed * elapsedTime));
    let camY = 5.0 * Math.sin(glMatrix.toRadian(45.0 * elapsedTime)) + 5.0;
