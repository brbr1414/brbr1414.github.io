...
if (!Shader.prototype.setInt) {
    Shader.prototype.setInt = function (name, v) { this.gl.uniform1i(this.getLoc(name), v); };
}
...
function render() {
    ...
    shader.setInt('u_shadingMode', renderingMode === 'PHONG' ? 0 : 1);
